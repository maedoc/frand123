...
contains
   ...
   subroutine time_frand123NormSingle_scalar_runner( state, compileCombination )
      ...
      ! create filename
      write( filename, '( "tuning/timings/frand123NormSingle_scalar_f", A, ".dat" )' ) trim( compileCombination )
   ...
   subroutine time_frand123NormSingle( state, num, chunksize, timeElapsed, resultSum )
      ...
      if( .not. allocated( randomNumber ) ) then
         write(*,*) 'error allocating randomNumber in time_frand123NormSingle Fortran version'
         stop 1
      endif
   ...
   subroutine time_frand123NormSingle_runner( state, compileCombination )
      ...
      ! create filename
      write( filename, '( "tuning/timings/frand123NormSingle_f", A, ".dat" )' ) trim( compileCombination )
